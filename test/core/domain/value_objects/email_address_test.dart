  ...
  group('EmailAddress', () {
    ...
    group('edge cases', () {
      ...
      test('handles email with hyphens in domain', () {
        // Note: The regex pattern [a-zA-Z0-9]+
        // doesn't allow hyphens in domain labels
        // So this will be invalid according to current validation
        final email = EmailAddress('test@sub-domain.example.com');
        // The regex doesn't support hyphens in domain labels
        expect(email.isValid, false);
      });
